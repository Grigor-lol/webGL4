...
var lightColorLocation = gl.getUniformLocation(shaderProgram, "u_lightColor");
var specularColorLocation = gl.getUniformLocation(shaderProgram, "u_specularColor");
...
// set the light color
gl.uniform3fv(lightColorLocation, [1/2.2, 0.6/2.2, 0.6/2.2]);  // red light
// set the specular color
gl.uniform3fv(specularColorLocation, [1/1.4, 0.2/1.4, 0.2/1.4]);  // red light
